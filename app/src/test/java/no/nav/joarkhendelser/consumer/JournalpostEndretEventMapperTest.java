...
public class JournalpostEndretEventMapperTest {

	private final JournalpostEndretEventMapper converter = new JournalpostEndretEventMapper();
	...
	public void shouldConvertUpdateOperation() {
		...
		JournalpostEndretEvent journalpostEndretEvent = converter.mapToJournalpostEndretEvent(event);
